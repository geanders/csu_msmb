...
> **Exercise 1.8 (p. 17)** Is the mitochondrial sequence of *C. elegans*
consistent with a model of equally likely nucleotides?
...
> Explore the nucleotide frequencies of chromosome M by using a dedicated
function in the *Biostrings* package from Bioconductor.
...
> Test whether the *C. elegans* data are consistent with the uniform 
model (all nucleotide frequencies the same) using a simulation.
